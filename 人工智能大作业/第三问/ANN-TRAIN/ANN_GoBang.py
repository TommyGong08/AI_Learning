...
# 训练模型
hist = model.fit(X_TRAIN,Y_TRAIN,epochs=5,batch_size=12)
# hist = model.fit(X_TRAIN,Y_TRAIN,epochs=200,batch_size=12,callbacks=[history])

# 保存模型
# model.save('model_200_12.h5')
